...
module Bmult18x18_bitheap_cmp_tb ();
    ...
    logic [9  : 0] col18_ts [`TS_SIZE-1 : 0];
    logic [8  : 0] col19_ts [`TS_SIZE-1 : 0];
    logic [7  : 0] col20_ts [`TS_SIZE-1 : 0];
    logic [7  : 0] col21_ts [`TS_SIZE-1 : 0];
    logic [6  : 0] col22_ts [`TS_SIZE-1 : 0];
    logic [6  : 0] col23_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col24_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col25_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col26_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col27_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col28_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col29_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col30_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col31_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col32_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col33_ts [`TS_SIZE-1 : 0];
    logic          col34_ts [`TS_SIZE-1 : 0];
    logic          col35_ts [`TS_SIZE-1 : 0];
