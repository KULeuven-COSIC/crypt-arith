...
module Bmult12x12_bitheap_cmp_tb ();
    ...
    logic [6  : 0] col12_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col13_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col14_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col15_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col16_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col17_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col18_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col19_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col20_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col21_ts [`TS_SIZE-1 : 0];
    logic          col22_ts [`TS_SIZE-1 : 0];
    logic          col23_ts [`TS_SIZE-1 : 0];
