...
module Bmult26x26_bitheap_cmp (
    ...
    input  logic [13 : 0] col26,
    input  logic [12 : 0] col27,
    input  logic [11 : 0] col28,
    input  logic [11 : 0] col29,
    input  logic [10 : 0] col30,
    input  logic [10 : 0] col31,
    input  logic [9  : 0] col32,
    input  logic [9  : 0] col33,
    input  logic [8  : 0] col34,
    input  logic [8  : 0] col35,
    input  logic [7  : 0] col36,
    input  logic [7  : 0] col37,
    input  logic [6  : 0] col38,
    input  logic [6  : 0] col39,
    input  logic [5  : 0] col40,
    input  logic [5  : 0] col41,
    input  logic [4  : 0] col42,
    input  logic [4  : 0] col43,
    input  logic [3  : 0] col44,
    input  logic [3  : 0] col45,
    input  logic [2  : 0] col46,
    input  logic [2  : 0] col47,
    input  logic [1  : 0] col48,
    input  logic [1  : 0] col49,
    input  logic          col50,
    input  logic          col51,
    ...
    assign C0_c3_2_l0_c2_i1 = {l0_c2_i0, layer0_col43[1:0]};
    
    assign layer1_col43[0] = O_c3_2_l0_c2_i1[0];
    ...
    assign C0_c3_2_l0_c2_i2 = {l0_c2_i1, layer0_col44[1:0]};
    
    assign layer1_col44[0] = O_c3_2_l0_c2_i2[0];
    ...
    assign C0_c3_2_l0_c2_i3 = {l0_c2_i2, layer0_col45[1:0]};
    
    assign layer1_col45[0] = O_c3_2_l0_c2_i3[0];
    assign layer1_col46[0] = O_c3_2_l0_c2_i3[1];
    ...
    // GPC0 in layer1: (3 : 2] at column 29
    ...
    assign C0_c3_2_l1_f0 = layer1_col29[3:1];
    
    assign layer2_col29[1] = O_c3_2_l1_i0[0];
    assign layer2_col30[1] = O_c3_2_l1_i0[1];
    ...
    assign C0_c223_4_l1_c4_i0 = layer1_col30[4:2];
    assign C1_c223_4_l1_c4_i0 = layer1_col31[3:2];
    assign C2_c223_4_l1_c4_i0 = layer1_col32[5:4];
    
    assign layer2_col30[2] = O_c223_4_l1_c4_i0[0];
    assign layer2_col31[1] = O_c223_4_l1_c4_i0[1];
    assign layer2_col32[1] = O_c223_4_l1_c4_i0[2];
    ...
    assign C0_c3_2_l1_c4_i1 = {l1_c4_i0, layer1_col33[2:1]};
    
    assign layer2_col33[1] = O_c3_2_l1_c4_i1[0];
    assign layer2_col34[1] = O_c3_2_l1_c4_i1[1];
    ...
    assign layer2_col30[3] = O_c3_2_l1_c6_i1[1];
