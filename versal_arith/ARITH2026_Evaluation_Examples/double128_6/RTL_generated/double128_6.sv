...
module Comp_double128_6 (
    ...
    always_ff @(posedge clk) begin
        layer1_col1[44] <= layer0_col1[92];
        layer1_col1[45] <= layer0_col1[93];
        layer1_col1[46] <= layer0_col1[94];
        layer1_col1[47] <= layer0_col1[95];
        layer1_col1[48] <= layer0_col1[96];
        layer1_col1[49] <= layer0_col1[97];
        layer1_col1[50] <= layer0_col1[98];
        layer1_col1[51] <= layer0_col1[99];
        layer1_col1[52] <= layer0_col1[100];
        layer1_col1[53] <= layer0_col1[101];
        layer1_col1[54] <= layer0_col1[102];
        layer1_col1[55] <= layer0_col1[103];
        layer1_col1[56] <= layer0_col1[104];
        layer1_col1[57] <= layer0_col1[105];
        layer1_col1[58] <= layer0_col1[106];
        layer1_col1[59] <= layer0_col1[107];
        layer1_col1[60] <= layer0_col1[108];
        layer1_col1[61] <= layer0_col1[109];
        layer1_col1[62] <= layer0_col1[110];
        layer1_col1[63] <= layer0_col1[111];
        layer1_col1[64] <= layer0_col1[112];
        layer1_col1[65] <= layer0_col1[113];
        layer1_col1[66] <= layer0_col1[114];
        layer1_col1[67] <= layer0_col1[115];
        layer1_col1[68] <= layer0_col1[116];
        layer1_col1[69] <= layer0_col1[117];
        layer1_col1[70] <= layer0_col1[118];
        layer1_col1[71] <= layer0_col1[119];
        layer1_col1[72] <= layer0_col1[120];
        layer1_col1[73] <= layer0_col1[121];
        layer1_col1[74] <= layer0_col1[122];
        layer1_col1[75] <= layer0_col1[123];
        layer1_col1[76] <= layer0_col1[124];
        layer1_col1[77] <= layer0_col1[125];
        layer1_col1[78] <= layer0_col1[126];
        layer1_col1[79] <= layer0_col1[127];
    end
    ...
    always_ff @(posedge clk) begin
        layer2_col0[1] <= layer1_col0[5];
        layer2_col0[2] <= layer1_col0[6];
        layer2_col0[3] <= layer1_col0[7];
        layer2_col1[6] <= layer1_col1[78];
        layer2_col1[7] <= layer1_col1[79];
        layer2_col2[26] <= layer1_col2[49];
        layer2_col2[27] <= layer1_col2[50];
        layer2_col2[28] <= layer1_col2[51];
        layer2_col2[29] <= layer1_col2[52];
        layer2_col2[30] <= layer1_col2[53];
    end
    ...
    always_ff @(posedge clk) begin
        ...
        layer3_col1[1] <= layer2_col1[5];
        layer3_col1[2] <= layer2_col1[6];
        layer3_col1[3] <= layer2_col1[7];
        layer3_col2[3] <= layer2_col2[27];
        layer3_col2[4] <= layer2_col2[28];
        layer3_col2[5] <= layer2_col2[29];
        layer3_col2[6] <= layer2_col2[30];
        layer3_col3[10] <= layer2_col3[25];
        layer3_col3[11] <= layer2_col3[26];
        layer3_col3[12] <= layer2_col3[27];
        layer3_col3[13] <= layer2_col3[28];
        layer3_col3[14] <= layer2_col3[29];
    end
    ...
    always_ff @(posedge clk) begin
        ...
        layer4_col2[1] <= layer3_col2[5];
        layer4_col2[2] <= layer3_col2[6];
        layer4_col4[5] <= layer3_col4[12];
        layer4_col4[6] <= layer3_col4[13];
    end
    ...
    always_ff @(posedge clk) begin
        ...
        layer5_col3[0] <= layer4_col3[0];
        layer5_col3[1] <= layer4_col3[1];
        layer5_col3[2] <= layer4_col3[2];
        layer5_col4[1] <= layer4_col4[5];
        layer5_col4[2] <= layer4_col4[6];
        layer5_col5[2] <= layer4_col5[6];
    end
