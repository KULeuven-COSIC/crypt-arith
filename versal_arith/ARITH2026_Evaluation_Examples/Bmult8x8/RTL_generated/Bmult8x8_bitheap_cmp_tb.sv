...
module Bmult8x8_bitheap_cmp_tb ();
    ...
    logic [4  : 0] col8_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col9_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col10_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col11_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col12_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col13_ts [`TS_SIZE-1 : 0];
    logic          col14_ts [`TS_SIZE-1 : 0];
    logic          col15_ts [`TS_SIZE-1 : 0];
