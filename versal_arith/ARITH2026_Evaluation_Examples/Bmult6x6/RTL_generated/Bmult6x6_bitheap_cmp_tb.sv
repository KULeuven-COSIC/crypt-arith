...
module Bmult6x6_bitheap_cmp_tb ();
    ...
    logic [3  : 0] col6_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col7_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col8_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col9_ts [`TS_SIZE-1 : 0];
    logic          col10_ts [`TS_SIZE-1 : 0];
    logic          col11_ts [`TS_SIZE-1 : 0];
