...
module Bmult32x32_bitheap_cmp_tb ();
    ...
    logic [15 : 0] col28_ts [`TS_SIZE-1 : 0];
    logic [14 : 0] col29_ts [`TS_SIZE-1 : 0];
    logic [16 : 0] col30_ts [`TS_SIZE-1 : 0];
    logic [15 : 0] col31_ts [`TS_SIZE-1 : 0];
    logic [16 : 0] col32_ts [`TS_SIZE-1 : 0];
    logic [15 : 0] col33_ts [`TS_SIZE-1 : 0];
    logic [14 : 0] col34_ts [`TS_SIZE-1 : 0];
    logic [14 : 0] col35_ts [`TS_SIZE-1 : 0];
    logic [13 : 0] col36_ts [`TS_SIZE-1 : 0];
    logic [13 : 0] col37_ts [`TS_SIZE-1 : 0];
    logic [12 : 0] col38_ts [`TS_SIZE-1 : 0];
    logic [12 : 0] col39_ts [`TS_SIZE-1 : 0];
    logic [11 : 0] col40_ts [`TS_SIZE-1 : 0];
    logic [11 : 0] col41_ts [`TS_SIZE-1 : 0];
    logic [10 : 0] col42_ts [`TS_SIZE-1 : 0];
    logic [10 : 0] col43_ts [`TS_SIZE-1 : 0];
    logic [9  : 0] col44_ts [`TS_SIZE-1 : 0];
    logic [9  : 0] col45_ts [`TS_SIZE-1 : 0];
    logic [8  : 0] col46_ts [`TS_SIZE-1 : 0];
    logic [8  : 0] col47_ts [`TS_SIZE-1 : 0];
    logic [7  : 0] col48_ts [`TS_SIZE-1 : 0];
    logic [7  : 0] col49_ts [`TS_SIZE-1 : 0];
    logic [6  : 0] col50_ts [`TS_SIZE-1 : 0];
    logic [6  : 0] col51_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col52_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col53_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col54_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col55_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col56_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col57_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col58_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col59_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col60_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col61_ts [`TS_SIZE-1 : 0];
    logic          col62_ts [`TS_SIZE-1 : 0];
    logic          col63_ts [`TS_SIZE-1 : 0];
    ...
    initial begin
        ...
        $readmemh("../../../../../testvectors/col56.txt", col56_ts);
        $readmemh("../../../../../testvectors/col57.txt", col57_ts);
        $readmemh("../../../../../testvectors/col58.txt", col58_ts);
        $readmemh("../../../../../testvectors/col59.txt", col59_ts);
        $readmemh("../../../../../testvectors/col60.txt", col60_ts);
        $readmemh("../../../../../testvectors/col61.txt", col61_ts);
        $readmemh("../../../../../testvectors/col62.txt", col62_ts);
        $readmemh("../../../../../testvectors/col63.txt", col63_ts);
