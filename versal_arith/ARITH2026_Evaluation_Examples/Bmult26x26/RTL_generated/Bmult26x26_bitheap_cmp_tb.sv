...
module Bmult26x26_bitheap_cmp_tb ();
    ...
    logic [13 : 0] col26_ts [`TS_SIZE-1 : 0];
    logic [12 : 0] col27_ts [`TS_SIZE-1 : 0];
    logic [11 : 0] col28_ts [`TS_SIZE-1 : 0];
    logic [11 : 0] col29_ts [`TS_SIZE-1 : 0];
    logic [10 : 0] col30_ts [`TS_SIZE-1 : 0];
    logic [10 : 0] col31_ts [`TS_SIZE-1 : 0];
    logic [9  : 0] col32_ts [`TS_SIZE-1 : 0];
    logic [9  : 0] col33_ts [`TS_SIZE-1 : 0];
    logic [8  : 0] col34_ts [`TS_SIZE-1 : 0];
    logic [8  : 0] col35_ts [`TS_SIZE-1 : 0];
    logic [7  : 0] col36_ts [`TS_SIZE-1 : 0];
    logic [7  : 0] col37_ts [`TS_SIZE-1 : 0];
    logic [6  : 0] col38_ts [`TS_SIZE-1 : 0];
    logic [6  : 0] col39_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col40_ts [`TS_SIZE-1 : 0];
    logic [5  : 0] col41_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col42_ts [`TS_SIZE-1 : 0];
    logic [4  : 0] col43_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col44_ts [`TS_SIZE-1 : 0];
    logic [3  : 0] col45_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col46_ts [`TS_SIZE-1 : 0];
    logic [2  : 0] col47_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col48_ts [`TS_SIZE-1 : 0];
    logic [1  : 0] col49_ts [`TS_SIZE-1 : 0];
    logic          col50_ts [`TS_SIZE-1 : 0];
    logic          col51_ts [`TS_SIZE-1 : 0];
